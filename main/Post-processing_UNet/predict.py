...
from utils import compute_average_stats, split_train_val
...
if __name__ == "__main__":
    ...
    ds = split_train_val(dataset, val_percent=0.20)
    train_dataset = ds['train'] # 400 train images
    test_dataset = ds['val']    # 100 test images
